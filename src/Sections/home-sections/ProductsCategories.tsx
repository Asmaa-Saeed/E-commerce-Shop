    ...
    <section className="py-32 px-4 bg-white text-center">
      ...
      <div className="grid grid-cols-1 my-6 sm:grid-cols-2 md:grid-cols-3 gap-14 max-w-6xl mx-auto">
        {categories.map((cat: Category, index: number) => (
          <div key={index} className="bg-white rounded-sm overflow-hidden duration-300 shadow-[0_0_10px_rgba(0,0,0,0.2)] hover:shadow-[0_0_25px_rgba(251,191,36,0.5)] hover:-translate-y-2  transition-all cursor-pointer">
